...
namespace CSharpTutA.cs
{
    ...
    class Program
    {
        ...
        {
            string[] dogs = {"K 9", "Brian Griffin", "K 20",
            "Scooby Doo", "Old Yeller", "K 10", "Rin Tin Tin",
            "Benji", "Charlie B. Barkin", "Lassie",
            "Snoopy"};

            int[] numbers = { 10, 1, 20, 2, 30, 3, 40, 4, 50, 5, 20 };

            var numberValues = from num in numbers
                               where num.Equals(20)
